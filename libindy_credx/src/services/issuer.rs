...
use ursa::cl::{
    CredentialKeyCorrectnessProof, CredentialPrivateKey, CredentialPublicKey, CredentialSignature,
    Nonce, RevocationKeyPrivate, RevocationRegistry, RevocationRegistryDelta,
...
use crate::domain::schema::AttributeNames;
...
impl Issuer {
    ...
    pub fn new_revocation_registry(
        &self,
